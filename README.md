...
Please note that [Helm do not support all globpatterns](https://helm.sh/docs/chart_template_guide/helm_ignore_file/) supported by ct. Downward compatibility is provided.
